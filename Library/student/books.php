...
<html>
  ...
  <body>
    ...
    <!--___________ request book _____________ -->
    <div class="srch">
      <form class="navbar-form" method="post" name="form1">

          <input class="form-control" type="text" name="search" placeholder="Enter Book ID" required="">
          <button style="background-color: #6db6b9e6" type="submit" name="submit_req" class="btn btn-default">
            Request
          </button>
      </form>
    </div>
  ...
  echo "</table>";
    ...
    if(isset($_POST['submit_req']))
    {
      ...
      {
        mysqli_query($db,"INSERT INTO `issue_book` VALUES('$_SESSION[login_user]', '$_POST[search]', '', '', '');");
        ?>
